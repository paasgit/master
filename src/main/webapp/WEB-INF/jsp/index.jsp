	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			<div class="layui-main">
				<a href="${ctx}/index.shtml" class="logo">IE-MANAGER</a>
				<!-- 顶部右侧菜单 -->
				<ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc><a href="javascript:;"> <img
							src="images/userface4.jpg" class="layui-circle" width="35"
		...
		<div class="layui-body">
			...
			<div id="mds_manager_body">
				...
				<h5 class="dx-welcome-title">欢迎进入后台管理系统，请点击左侧菜单开始操作吧！</h5>
			</div>
		</div>
		<div class="layui-footer footer">
			<div class="layui_main">
				<p>@2017 java开源后台管理系统</p>
			</div>
		</div>
	</div>
