...
public class ResourceController {
	...
	public String resourceIsExist(Model model,HttpServletRequest request) {
	...
	public String updateRresourceStatus(Model model,HttpServletRequest request) {
	...
	public String resourceAdd(Model model,HttpServletRequest request){
		Log.info(">>进入资源添加方法");
	...
	public String resourceUpdate(Model model,HttpServletRequest request){
		Log.info(">>进入资源更新方法");
	...
	public String resourceDel(Model model,HttpServletRequest request){
		Log.info(">>进入资源删除方法");
